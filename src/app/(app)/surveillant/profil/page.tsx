...
export default function SurveillantProfilPage() {
  ...
  const [infoForm, setInfoForm] = useState({
    firstName: (u?.firstName as string | undefined) ?? user?.prenom ?? '',
    lastName: (u?.lastName as string | undefined) ?? user?.nom ?? '',
    email: user?.email ?? '',
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', background: '#f5f7fa' }}>
      ...
      <div style={{ background: '#fff', borderBottom: '1px solid #e6ebf1', minHeight: 62, flexShrink: 0, display: 'flex', alignItems: 'center', padding: '0 28px', flexWrap: 'wrap', gap: 10 }}>
        <div>
          ...
          <div style={{ fontSize: 12, color: '#64748b' }}>Vie scolaire — Surveillant</div>
        </div>
      </div>
        ...
        <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap', maxWidth: 880 }}>
          ...
          <div style={{ flex: '0 0 220px', minWidth: 180 }}>
            <div style={{ background: '#fff', border: '1px solid #e6ebf1', padding: 24, textAlign: 'center' }}>
              ...
              <div style={{ marginTop: 12, display: 'inline-block', padding: '4px 12px', background: '#f3e8ff', color: '#7c3aed', fontSize: 11, fontWeight: 700 }}>
                SURVEILLANT
              </div>
            </div>
          </div>
